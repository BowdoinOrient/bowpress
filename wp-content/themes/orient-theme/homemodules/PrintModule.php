<?php
	...
	$date = just_variable( "date", FALSE );
?>

<!--
<a class="print-edition-module" href="http://www.scribd.com/bowdoinorient">
	...
	Last published on <?php echo $date; ?>.</p>
</a>
-->
...
<div class="row">
	<div class="col col-xs-12">
		<a class="print-edition-module" href="http://www.scribd.com/bowdoinorient/uploads">
			...
			<h1>Explore the print edition.</h1>
			<p>Browse this week's paper and view our archives.</br>Last published on <?php echo $date; ?>.</p>
		</a>
	</div>
</div>
