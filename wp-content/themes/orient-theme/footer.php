...
<footer class="page-foot">
	<div class="page-foot__nameplate">
	...
	<div class="page-foot__social">
		...
		<a href="https://twitter.com/bowdoinorient" class="twitter-icon">
		...
		<a href="https://vimeo.com/bowdoinorient" class="vimeo-icon">
		...
		<a href="https://www.instagram.com/bowdoinorient/" class="instagram-icon">
	...
	<div class="text-links">
		...
		<div class="page-foot__medium">
			<a href="/random">Random</a>
			<a href="/about">About</a>
			<a href="/masthead">Staff</a>
	...
	<div class="page-foot__bottom">&copy; <?php echo date('Y'); ?> The Bowdoin Orient</div>
</footer>
...
<!-- Custom JavaScript -->
<script async src="<?php echo get_template_directory_uri() ?>/js/script.js?10202017"></script>
