<?php 
	echo 'http://' . $_SERVER['HTTP_HOST'] . '/bonus' . $_SERVER['REQUEST_URI'];
	if(file_get_contents('http://' . $_SERVER['HTTP_HOST'] . '/bonus' . $_SERVER['REQUEST_URI'], NULL, NULL, 0, 24) == "<!-- @orient-archive -->") {
		header("HTTP/1.1 301 Moved Permanently");
		header('Location: http://' . $_SERVER['HTTP_HOST'] . '/bonus' . $_SERVER['REQUEST_URI']);
		exit();
	}
