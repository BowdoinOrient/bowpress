		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<header class="single__article-header">
				...
				<?php if (get_field("opinion", $post->ID)): ?>
					<div class="single__disclaimer"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/bubble.svg">This
				...
				<?php if (get_field("editorial", $post->ID)): ?>
					<div class="single__disclaimer"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/megaphone.svg">This
						piece represents the opinion of the Bowdoin Orient Editorial Board.</div>
				<?php endif; ?>
			...
			<aside class="single__sidebar">
				...
				<div class="single__share-box">
					<a href="http://www.facebook.com/sharer.php?u=<?php echo "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]"; ?>"
						target="_blank" class="social-link facebook-share" title="Share on Facebook">
					...
					<a href="http://twitter.com/share?text=A%20Bowdoin%20Orient%20article&url=<?php echo "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]"; ?>"
						target="_blank" class="social-link twitter-share" title="Share on Twitter">
					...
					<a href="mailto:?subject=A%20Bowdoin%20Orient%20article%20for%20you&amp;body=Check%20out%20this%20article!%0D%0A%0D%0A<?php echo "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]"; ?>"
						class="social-link email-share" title="Share via Email">
						<svg version="1.1" id="Mail" xmlns="http://www.w3.org/2000/svg"
							xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 20 20"
					...
					<a href="javascript:window.print();" class="social-link print-share" title="Print this article">
						<svg version="1.1" id="Print" xmlns="http://www.w3.org/2000/svg"
							xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 20 20"
							enable-background="new 0 0 20 20" xml:space="preserve">
			...
			<footer class="single__footer">
				...
				<div class="callout">
					...
					<p class="callout__description">Catch up on the latest reports, stories and opinions about Bowdoin and
						Brunswick in your inbox. Always high-quality. Always free.</p>
					<form
						action="http://bowdoinorient.us4.list-manage.com/subscribe/post?u=eab94f63abe221b2ef4a4baec&amp;id=739fef0bb9"
					...
					<p class="callout__footer">We'll never use your email for anything other than this newsletter. Read our full
