...
<body <?php body_class(); ?>>
	...
	<div class="mobile-drawer">
		...
		<ul class="mobile-drawer__list">
			...
			<li><a href="<?php echo is_user_logged_in() ? wp_logout_url('/') : wp_login_url('wp-admin') ?>">Admin Log
					In/Out</a></li>
		</ul>
	</div>
	...
	<div class="mobile-top-bar">
		<a class="mobile-top-bar__drawer-toggle">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
				<path
					d="M16.4 9H3.6C3 9 3 9.4 3 10c0 0.6 0 1 0.6 1H16.4c0.6 0 0.6-0.4 0.6-1C17 9.4 17 9 16.4 9zM16.4 13H3.6C3 13 3 13.4 3 14c0 0.6 0 1 0.6 1H16.4c0.6 0 0.6-0.4 0.6-1C17 13.4 17 13 16.4 13zM3.6 7H16.4C17 7 17 6.6 17 6c0-0.6 0-1-0.6-1H3.6C3 5 3 5.4 3 6 3 6.6 3 7 3.6 7z" />
			</svg>
			<svg class="js-hidden" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
				viewBox="0 0 20 20">
				<path
					d="M12.452,4.516c0.446,0.436,0.481,1.043,0,1.576L8.705,10l3.747,3.908c0.481,0.533,0.446,1.141,0,1.574c-0.445,0.436-1.197,0.408-1.615,0c-0.418-0.406-4.502-4.695-4.502-4.695C6.112,10.57,6,10.285,6,10s0.112-0.57,0.335-0.789c0,0,4.084-4.287,4.502-4.695C11.255,4.107,12.007,4.08,12.452,4.516z" />
			</svg>
		</a>

		<a href="/" class="mobile-top-bar__nameplate"><img
				src="<?php echo get_stylesheet_directory_uri(); ?>/img/nameplate.svg" alt=""></a>
	</div>
		...
		<div class="top-bar">
			<div class="top-bar__social-links top-bar__component">
				<a href="https://www.facebook.com/bowdoinorient" class="facebook-icon" target="_blank">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
						<path
							d="M17 1H3C1.9 1 1 1.9 1 3v14c0 1.1 0.9 2 2 2h7v-7H8V9.5h2V7.5c0-2.2 1.2-3.7 3.8-3.7l1.8 0v2.6h-1.2C13.4 6.4 13 7.1 13 7.8v1.7h2.6L15 12h-2v7h4c1.1 0 2-0.9 2-2V3C19 1.9 18.1 1 17 1z" />
					</svg>
				</a>
				...
				<a href="https://vimeo.com/bowdoinorient" class="vimeo-icon" target="_blank">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
						<path
							d="M18.9 5.8c-1 5.8-6.6 10.7-8.3 11.8 -1.7 1.1-3.2-0.4-3.8-1.6C6.2 14.6 4.2 7.3 3.7 6.7 3.2 6.1 1.7 7.3 1.7 7.3L1 6.4c0 0 3.1-3.7 5.4-4.2C8.9 1.7 8.9 6 9.5 8.4c0.6 2.3 1 3.7 1.5 3.7 0.5 0 1.5-1.3 2.5-3.3 1.1-2 0-3.8-2.1-2.5C12.1 1.3 19.9 0.1 18.9 5.8z" />
					</svg>
				</a>
				...
				<?php if (!is_user_logged_in()): ?>
					...
					<a href="<?php echo wp_login_url('wp-admin') ?>" class="wordpress-login-icon">
						<svg id="Star" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
			...
			<div class="top-bar__search-link top-bar__component">
				<a href="#" class="search-icon" id="searchIcon">
					...
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
						<path
							d="M17.5 15.5l-3.8-3.8c0.6-0.9 0.9-2 0.9-3.2 0-3.4-3-6.4-6.4-6.4C4.9 2.1 2.1 4.9 2.1 8.3c0 3.4 3 6.4 6.4 6.4 1.1 0 2.2-0.3 3.1-0.8l3.8 3.8c0.4 0.4 1 0.4 1.3 0l0.9-0.9C18.1 16.3 17.9 15.8 17.5 15.5zM4 8.3c0-2.4 1.9-4.3 4.3-4.3 2.4 0 4.5 2.1 4.5 4.5 0 2.4-1.9 4.3-4.3 4.3C6.1 12.8 4 10.7 4 8.3z" />
					</svg>
					<!-- </span>
			<span class="close js-hidden"> -->
					<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 20 20"
						enable-background="new 0 0 20 20" xml:space="preserve" class="js-hidden">
						<path
							d="M14.348,14.849c-0.469,0.469-1.229,0.469-1.697,0L10,11.819l-2.651,3.029c-0.469,0.469-1.229,0.469-1.697,0c-0.469-0.469-0.469-1.229,0-1.697l2.758-3.15L5.651,6.849c-0.469-0.469-0.469-1.228,0-1.697c0.469-0.469,1.228-0.469,1.697,0L10,8.183l2.651-3.031c0.469-0.469,1.228-0.469,1.697,0c0.469,0.469,0.469,1.229,0,1.697l-2.758,3.152l2.758,3.15C14.817,13.62,14.817,14.38,14.348,14.849z" />
					</svg>
					<!-- </span> -->
				</a>
			</div>
...
within the page-wrap div. -->
		<div class="page-wrap">
				...
				<div class="home-header">
					...
					<nav class="home-nav">
						<div class="home-nav__links home-nav__section-links ">
							...
							<a href="/section/arts-entertainment" class="arts-entertainment"
								data-section="arts-entertainment">Arts &amp; Entertainment</a>
						...
						<div class="home-nav__links home-nav__more-links">
							...
							<a href="#" class="more-menu-toggle">More
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/chevron-down.svg"
									class="more-menu-toggle__chevron-down">
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/chevron-up.svg"
									class="more-menu-toggle__chevron-up js-hidden">
							</a>
						</div>
			...
			<div class="alert alert-red small-screen-alert">
				...
				<p>You seem to be browsing on a screen size, browser, or device that this website cannot support. Some
					things might look and act a little weird.</p>
			</div>
